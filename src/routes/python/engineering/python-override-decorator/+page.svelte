...
<article class="layout-md py-12 mx-auto max-w-3xl px-6">
  ...
  <div class="prose prose-neutral max-w-none">
    ...
    <p>
      Without any checks, your code will run, but the base class's <code
        >log()</code
...
# NOT write to a file as intended!</code
      ></pre>

    <p>
      The <code>@override</code> decorator from the <code>typing</code> module is
    ...
    <p>
      If you use <code>@override</code> and the method doesn't actually exist in
...
class FileLogger(Logger):
    ...
    <ul>
      ...
      <li>
        <strong>pyright/Pylance</strong> - Microsoft's type checker (default in VS
        Code)
      </li>
...
# Pyre Invalid override [40]: `log_to_file` is not defined in base classes of `FileLogger`</code
      ></pre>

  ...
  <ul>
    ...
    <li>
      ...
      <ul>
        ...
        <li>
          TA for
          <Link to="https://sgi.mit.edu/">Summer Geometry Institute (SGI)</Link
          >, Summer 2021
        </li>
    ...
    <li>
      <b>Selected coursework (&dagger; graduate-level):</b>
      <ul>
        <li>Computational Complexity<sup>&dagger;</sup> (CS 221)</li>
        <li>Randomized Algorithms<sup>&dagger;</sup> (CS 223)</li>
        <li>Computational Learning Theory<sup>&dagger;</sup> (CS 228)</li>
        <li>PL/AI Graduate Seminar<sup>&dagger;</sup> (CS 252r)</li>
        <li>Systems Security<sup>&dagger;</sup> (CS 263)</li>
        <li>Distributed Systems Engineering<sup>&dagger;</sup> (MIT 6.824)</li>
        <li>Shape Analysis<sup>&dagger;</sup> (MIT 6.838)</li>
        <li>Robotic Manipulation<sup>&dagger;</sup> (MIT 6.843)</li>
        <li>Graduate Probability<sup>&dagger;</sup> (Stat 210)</li>
        <li>Graduate Statistical Inference<sup>&dagger;</sup> (Stat 211)</li>
...
<section class="container py-6">
  ...
  <h3>
    Software Engineering Intern at <Link to="https://scale.com/">Scale AI</Link>
  </h3>
  ...
  <h3>
    Coauthor at
    <Link to="https://aapt.org/">American Association of Physics Teachers</Link>
  </h3>
...
<section class="container py-6">
  ...
  <ul>
    <li>
      <b>Mathematical Olympiad Program (MOP):</b> Participant (2017), IMO team selection
      group (2017, 2018)
    </li>
    <li>
...
<style lang="postcss">
  h2 {
    @apply text-3xl font-serif mb-3.5;
  }

  h3 {
    @apply text-xl font-serif mt-3.5 mb-0.5;
  }
